...
{ // Deklarerar en funktion för att initiera USART-protkokollet och dess beståndsdelar
...
{ // Deklarerar skrivfunktionen (Överföringen av data till terminalen)
...
{ // Deklarerar läsfunktionen (mottagning av information)
